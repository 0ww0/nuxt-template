...
// Cache key: import GENERAL_CACHE_STORAGE_KEY from './index.get'
// Short TTL (5 min): maintenance mode must propagate quickly even if a purge fails.
...
export default cachedEventHandler(async () => {
  ...
  getKey: () => 'singleton',
  maxAge: 60 * 5, // 5 minutes — short so maintenance mode propagates quickly
})
